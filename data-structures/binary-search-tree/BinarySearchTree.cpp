...
int main() 
{
    ...
    // Displays pre-order, in-order, post-order, and level-order representations of current nodes
    BST.Display(); 

    // Provides the BST min. value
    BST.Min(); 

    // Provides the BST max. value
    BST.Max(); 

    // Provides the height of the BST
    BST.GetHeight(); 
    ...
    // Clears all nodes in the binary search tree
    BST.Clear();
};